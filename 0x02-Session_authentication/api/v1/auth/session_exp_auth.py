...
class SessionExpAuth(SessionAuth):
    ...
    This class extends SessionAuth and adds an expiration date to a session ID.
    """
    ...
    def __init__(self):
        ...
        Sets the session duration based on the environment variable SESSION_DURATION.
        """
        try:
